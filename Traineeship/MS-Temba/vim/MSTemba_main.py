...
parser.add_argument("-in_feat_dim", type=int, default=512, help="feature dimension D of the .npy inputs")
...
in_feat_dim = int(args.in_feat_dim)
...
if __name__ == '__main__':
    ...
    if args.dataset == 'charades':
        #train_split = './_mini_charades/charades_mini.json'
        #test_split = train_split
        train_split = '../data/Charades_v1_train.json'
        test_split  = '../data/Charades_v1_test.json'    
